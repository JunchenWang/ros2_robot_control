...
namespace controllers
{
    ...
    public:
        ...
        ~VirtualFixturePlaneController()
        {
            if (data_logger_)
            {
                data_logger_->save(FileUtils::getHomeDirectory() + "/experiment_logs/virtual_fixture_plane_controller/", "virtual_fixture_plane_controller");
                delete data_logger_;
            }
            if (visual_tools_)
        ...
        void update(const rclcpp::Time &t, const rclcpp::Duration &period) override
        {
            ...
            tau_cmd = MathUtils::saturateTorque(tau_cmd, tau_d, 0.1);
