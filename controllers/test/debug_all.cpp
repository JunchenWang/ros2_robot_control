...
#include "robot_msgs/msg/vector_data.hpp"
...
public:
    ...
    rclcpp::Publisher<robot_msgs::msg::VectorData>::SharedPtr vec_pub1_;
    rclcpp::Publisher<robot_msgs::msg::VectorData>::SharedPtr vec_pub2_;
};
