...
namespace control_node
{
    ...
    protected:
        ...
        realtime_tools::RealtimeThreadSafeBox<controller_interface::ControllerInterface::SharedPtr> active_controller_box_;
        ...
        realtime_tools::RealtimeThreadSafeBox<std::vector<controller_interface::ControllerInterface::SharedPtr>> secondary_controllers_box_;
